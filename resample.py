...
if __name__ == '__main__':
    ...
    parser.add_argument('--tissue_threshold', type=float, default=.3, help='threshold to decide tissue or not')
    parser.add_argument('--drop_threshold', type=float, default=.0001, help='threshold of the wrong label ratio')
